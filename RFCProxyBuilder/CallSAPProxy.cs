...
namespace RFCProxyBuilder
{
    ...
    public class CallSAPProxy : SAPServerConnector
    {
        ...
        private bool ConnectSAPServer(string strTYPE, string strASHOST, short nSYSNR, short nCLIENT, string strLANG, string strUSER, string strPASSWD)
        {
            ...
            bRetVal = base.ConnectSAPServer(); // SAP
        ...
        /// <returns>SAP  (ADO.NET DataTable)</returns>
        ...
        {
            RFC_FUNINTTable oRFCFT = null; // RFC_FUNINT 
        ...
        /// <param name="nTabLen"></param>
        /// <returns>RFC  (ADO.NET DataTable)</returns>
        ...
        /// </summary>
        /// <param name="strTabName"</param>
        /// <param name="nLen1"></param>
        /// <param name="nLen2"></param>
        /// <returns>RFC  (ADO.NET DataTable)</returns>
        ...
        /// <returns>RFC (ADO.NET DataTable of X031L elements)</returns>
        ...
        private void GetRFCStructDef(ref XmlNode oParentNode)
        {
            ...
            XmlDocument oXmlDoc = null;  // XML 
            XmlNode oDTNode = null;      // IMPORT 
            XmlNode oImportedNode = null;// IMPORT
